...
$form->add_element( 'select', 'map_all_control[wpgmp_category_order]', array(
	'label' => __( 'Sort Category By', WPGMP_TEXT_DOMAIN ),
	'current' => $data['map_all_control']['wpgmp_category_order'],
	'desc' => __( 'Select Sort Criteria For Categories Tab.', WPGMP_TEXT_DOMAIN ),
...
$form->add_element( 'select', 'map_all_control[wpgmp_category_location_sort_order]', array(
	'label' => __( 'Sort Order Of Locations', WPGMP_TEXT_DOMAIN ),
	'current' => $data['map_all_control']['wpgmp_category_location_sort_order'],
	'desc' => __( 'Specify Sort Order For Locations/Places Under Categories In Tab.', WPGMP_TEXT_DOMAIN ),
