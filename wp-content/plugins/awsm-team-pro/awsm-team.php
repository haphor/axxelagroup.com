 ...
 */ 
    class Awsm_team
    {
        private $text_domain = 'awsm-team-pro';
        private $settings;
        ...
        {
            load_textdomain($this->text_domain, WP_LANG_DIR . "/awsm-team-pro/awsm-team-pro-" . apply_filters('plugin_locale', get_locale(), 'awsm-team-pro') . ".mo");
        ...
        function vc_support(){
            ...
            if(function_exists('vc_map')) {
               vc_map( array(
                           "name" => __("Awsm Team", $this->text_domain),
                           "description" => __("Awsm Team", $this->text_domain),
                           "base" => "awsmteam",
                           "controls" => "full",
                           ...
                           "params" => array(
                               array(
                                 ...
                                 "holder" => "div",
                                 "class" => "",
                                 "heading" => __("Select Team",  $this->text_domain),
                                 "param_name" => "id",
