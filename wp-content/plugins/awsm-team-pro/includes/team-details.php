				...
				<div class="awsm-team-customize-style">
					...
					<div class="awsm-preset-list awsm-clearfix">
								...
								foreach ($styles as $key => $set):
								    $val = strtolower($key);?>
								<input class="awsm-radio-hidden" id="rad-<?php echo $val;?>" type="radio" data-style="<?php echo $set[0];?>" data-column="<?php echo $set[1];?>" name="team-style" value="<?php echo $val;?>" <?php checked($val,$options['team-style']);?>>
