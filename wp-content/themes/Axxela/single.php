...
<section id="content" <?php Avada()->layout->add_style( 'content_style' ); ?>>
	...
	<?php if( in_category( 'press-releases' ) ): ?>
		<?php if( is_active_sidebar( 'first_contact' ) ) : ?>
		<div id="press-post-contact">
			<div class="col-12 col-sm-5"
				<?php dynamic_sidebar('first_contact') ?>
			</div>
			<?php if( is_active_sidebar( 'second_contact' ) ) : ?>
			<div class="col-12 col-sm-5"
				<?php dynamic_sidebar('second_contact') ?>
			</div>
			<?php endif; ?>
		</div>
		<?php endif; ?>
